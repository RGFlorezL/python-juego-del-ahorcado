...
# Función para obtener aleatoriamente una palabra secreta
def obtener_palabra_secreta() -> str:
    palabras = ['python', 'javascript', 'java', 'angular', 'django', 'tensorflow', 'react', 'typescript', 'git', 'flask']
    return random.choice(palabras)

# Función para mostrar el progreso del jugador (letras adivinadas y guiones bajos)
...
def juego_ahorcado():
    ...
    print(f"Tienes {intentos} intentos para adivivar la palabra secreta")
